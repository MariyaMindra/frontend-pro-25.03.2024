...
if (userYearOfBirth === null && userCity === null && userFavoriteSport === null)
{
    ...
    let userAgeMessage;
    if (userYearOfBirth != null && userYearOfBirth.length == 4 && !isNaN(parseInt(userYearOfBirth))) {
        const userAge = 2024 - userYearOfBirth;
        userAgeMessage = 'Your age is: ' + userAge;
    } else userAgeMessage = 'Sorry, but you did not provide information about year of birth.';
    let userCityMessage;
    if (userCity != null && userCity.length != 0) {
        userCityMessage ='You live in the city '+userCity;
        if (userCity === 'Kyiv' || userCity === 'Washington' || userCity === 'London'){
            userCityMessage = 'You live in the capital ' + userCity;}
    } else userCityMessage = 'Sorry, but you did not provide information about your city.';

    let sportMessage = 'Your favorite sport is ' + userFavoriteSport;
    switch (userFavoriteSport) {
        case null || userFavoriteSport.length == 0: {
